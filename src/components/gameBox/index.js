...
const GameBox = () => {
	...
	const chooseType = (type, test) => {
		switch(type){
			case "translate": return <TranslateGame test={test} setLevel = {setLevel}/>;
	...
	return (
		<GameBoxWrapper>
			...
			<div className="game-footer py-5 px-5 d-flex justify-content-between align-items-center">
				<Button variant={"outlined"} color={'primary'} onClick={nextLevel} >next</Button>
				<Button variant={"contained"} color={'success'} onClick={nextLevel}>Submit</Button>
			</div>
		</GameBoxWrapper>
	)
}
